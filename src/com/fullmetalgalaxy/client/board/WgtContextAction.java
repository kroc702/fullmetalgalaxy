...
public class WgtContextAction extends WgtView implements ClickHandler
{
  ...
  PushButton m_btnInfo = new PushButton( Icons.s_instance.info32().createImage() );
  PushButton m_btnTakeOff = new PushButton( Icons.s_instance.takeOff32().createImage() );
  PushButton m_btnTimeMode = new PushButton( Icons.s_instance.time32().createImage() );
  PushButton m_btnMiniMap = new PushButton( Icons.s_instance.map32().createImage() );
  PushButton m_btnPlayer = new PushButton( Icons.s_instance.player32().createImage() );
