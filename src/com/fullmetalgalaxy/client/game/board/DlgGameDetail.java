...
import com.fullmetalgalaxy.client.game.tabmenu.WgtConstructReserve;
import com.fullmetalgalaxy.client.game.tabmenu.WgtGameLogs;
...
public class DlgGameDetail extends DialogBox implements ClickHandler, SelectionHandler<Integer>
{
  ...
  private WgtGameTime m_wgtConfigTime = new WgtGameTime();
  //private Composite m_wgtConfigVariant = new Composite(){};
  ...
  public void onSelection(SelectionEvent<Integer> p_event)
  {
    ...
    case 2: // reserve 
      ...
      break;
    case 3: // time
      m_wgtConfigTime.onModelUpdate( ModelFmpMain.model() );
      m_wgtConfigTime.setReadOnly( true );
      break;
    case 4: // variant
