...
/**
 * @author vlegendr
 * handler for /_ah/xmpp/subscription/subscribe/ 
 * signal that the user wishes to subscribe to the application's 
 */
public class XMPPSuscribeServlet extends HttpServlet
{
